...
CREATE OR REPLACE FUNCTION insert_or_update_stream_version(aggregate_type text, aggregate_id uuid, current_seq_id integer)
RETURNS VOID
LANGUAGE plpgsql
AS $$
DECLARE
...
BEGIN
    ...
    INSERT INTO stockydb."SequenceVersions" (
